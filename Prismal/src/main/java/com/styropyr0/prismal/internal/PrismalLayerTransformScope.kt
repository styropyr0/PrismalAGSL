...
internal class PrismalLayerTransformScope : GraphicsLayerScope {
    ...
    fun DrawTransform.inverseTransform(
        ...
        this@PrismalLayerTransformScope.size = size
        this@PrismalLayerTransformScope.density = density.density
