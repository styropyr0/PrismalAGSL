...
internal class PrismalContinuousCurvatureCornerBuilder(
    ...
    companion object {
        val Default = PrismalContinuousCurvatureCornerBuilder()
    }
}
...
private fun solveDepressedQuarticSingle(p: Double, q: Double, r: Double): Double {
    ...
    val rTerm = sqrt(-f * f * f / 27.0)
    val phi = acos(-g / (2.0 * rTerm))
