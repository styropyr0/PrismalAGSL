...
internal fun prismalRoundedRectangleOutline(
    size: Size,
    radius: Float,
    style: PrismalRoundedCornerStyle
): Outline {
    ...
    return when {
        ...
        style == PrismalRoundedCornerStyle.Circular || (width == height && radius >= maxRadius) -> {
            ...
            Outline.Generic(prismalContinuousCurvatureRoundedRectanglePath(size, radius))
        }
    }
}
...
internal fun prismalRoundedRectangleOutline(
    ...
    return when {
        ...
        style == PrismalRoundedCornerStyle.Circular ||
            ...
            Outline.Generic(
                prismalContinuousCurvatureRoundedRectanglePath(
                    size = size,
                    topLeft = topLeft,
                    topRight = topRight,
...
private fun prismalContinuousCurvatureRoundedRectanglePath(
    size: Size,
    radius: Float,
    path: Path? = null
): Path {
    ...
    return path.apply {
        val cornerBuilder = PrismalContinuousCurvatureCornerBuilder.Default
